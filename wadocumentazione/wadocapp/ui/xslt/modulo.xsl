...
<!-- ********************************************************************** -->
<!--  template del modulo                                                   -->
<!--salvo per qualche dettaglio l'xsl e' identico a quello di default      t-->
<!-- ********************************************************************** -->
<xsl:template match="wamodulo">
	...
	<xsl:text>&#10;</xsl:text>
	<form id='{nome}' action='{pagina_destinazione}' method='post' enctype='{enctype}' class='wamodulo' style='{$mysinistra}; top: {alto}px; width: {larghezza}px; height: {altezza}px;'>
		<div>
