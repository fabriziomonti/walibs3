...
<xsl:template match="wamenu">
	...
	<table  cellpadding='0' cellspacing='0' onmouseover='toggleDDMM("{nome}", true, "{wamenu_path}/uis/wa_file_comuni/img")' id='{nome}_toggler_container' class='ddmx_toggler'>
		<tr>
			<td>
	...
	var wamenu_scomparsaAutomatica_<xsl:value-of select="nome"/> = true;
	</script>
</xsl:template>
