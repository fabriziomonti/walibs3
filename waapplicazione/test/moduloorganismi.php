...
*/
//*****************************************************************************
class moduloorganismi extends applicazioneTest
	{
	...
	*/
	function creaModulo()
		...
		$dbconn = $this->dammiConnessioneDB();
	  	...
	  	if ($_GET['id_organismo'])
			...
			// ricerca allo specifico organismo
	  		$sql .= " WHERE id_organismo=" . $dbconn->interoSql($_GET['id_organismo']);
	  	else 
		...
		$ctrl = $this->modulo->aggiungiIntero("ID_ORGANISMO", "Identificativo", true);
		$ctrl = $this->modulo->aggiungiTesto("NOME", "Ragione sociale", false, true);
