{include file="header.tpl" eltype="classe" hasel=true contents=$classcontents}
...
<h3><a href="#class_details">{if $is_interface}Interface{else}{/if} Panoramica</a></h3>
...
<td valign="top">
<h3><a href="#class_vars">Proprietà</a></h3>
<ul>
...
<td valign="top">
<h3><a href="#class_methods">Metodi</a></h3>
<ul>
