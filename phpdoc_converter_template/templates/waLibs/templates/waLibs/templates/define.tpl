{if count($defines) > 0}
	{section name=def loop=$defines}
		...
		{else}
			...
			<!--<h3>{$defines[def].define_name} 
				<span class="smalllinenumber">[line {if $defines[def].slink}{$defines[def].slink}{else}{$defines[def].line_number}{/if}]</span>
			</h3>-->
			<div class="tags">
			...
			<div class="top" style="margin-bottom: 10px;">[ <a href="#top">Top</a> ]</div>
		{/if}
	{/section}
{/if}