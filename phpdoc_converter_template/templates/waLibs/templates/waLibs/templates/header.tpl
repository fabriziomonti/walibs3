			...
			<tr>
				<td class="header_menu">
					...
					{if $packagehaselements}
						[ <a href="{$subdir}classtrees_{$package}.html" class="menu">albero delle classi</a> ]
						[ <a href="{$subdir}elementindex_{$package}.html" class="menu">indice degli elementi</a> ]
					{/if}
			...
			<tr valign="top">
				<td width="200" class="menu">
					...
					{section name=packagelist loop=$packageindex}
						<a href="{$subdir}{$packageindex[packagelist].link}">Introduzione</a><br />
					{/section}
					<br />
					{if $tutorials}
				...
				{if !$noleftindex}
					...
					{if $compileddefineindex}
						<b>{eval var=$compileddefineindex}</b>
					{/if}
